...
function CreatePin({user}) {
  ...
  return (
    <div className='flex flex-col justify-center items-center mt-5 lg:h-4/5'>
      {/* valida si el campo no esta llenado con un true en el useState */}
      {fields && (
        <p className='text-red-500 mb-5text-xl transition-all duration-150 ease-in'>Please fill all the fields</p>
      )}
          ...
          <div className='flex justify-center items-center flex-col border-2 border-dotted border-gray-300 p-3 w-full h-420'>
            ...
            {!imageAsset ? (
              <label>
                <div className='flex flex-col items-center justify-center h-full'>
                  <div className='flex flex-col justify-center items-center'>
                    <p className='font-bild text-2xl'>
              ...
              <div className='relative h-full'>
                <img src={imageAsset?.url} alt="Uploades-pic" className='w-full h-full' />
                <button
                type='button'
